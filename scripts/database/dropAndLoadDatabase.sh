...
dropdb -h localhost -U evoge_user $1 -p $3

echo "Criando o banco de dados $1"
createdb -h localhost -U evoge_user $1 -p $3

echo "Restaurando o banco de dados $1 a partir do arquivo $2"
pg_restore --verbose -h localhost -U evoge_user -p $3 -d $1 -x --no-owner --role=evoge_user -j 2 -F c $2
