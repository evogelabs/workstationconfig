...
# |                                      |                                                              |                               |
# | azure-active-directory               | Spring Security integration with Azure Active Directory for  | >=2.5.0-M1 and <3.0.0-M1      |
# |                                      | authentication.                                              |                               |
# |                                      |                                                              |                               |
...
# |                                      |                                                              |                               |
# | azure-keyvault                       | All key vault features are supported, e.g. manage            | >=2.5.0-M1 and <3.0.0-M1      |
# |                                      | application secrets and certificates.                        |                               |
# |                                      |                                                              |                               |
# | azure-storage                        | All Storage features are supported, e.g. blob, fileshare and | >=2.5.0-M1 and <3.0.0-M1      |
# |                                      | queue.                                                       |                               |
# |                                      |                                                              |                               |
# | azure-support                        | Auto-configuration for Azure Services (Service Bus, Storage, | >=2.5.0-M1 and <3.0.0-M1      |
...
# |                                      | HashiCorp Vault.                                             |                               |
# |                                      |                                                              |                               |
# | cloud-contract-stub-runner           | Stub Runner for HTTP/Messaging based communication. Allows   | >=2.3.0.M1 and <3.0.0-M1      |
# |                                      | creating WireMock stubs from RestDocs tests.                 |                               |
# |                                      |                                                              |                               |
# | cloud-contract-verifier              | Moves TDD to the level of software architecture by enabling  | >=2.3.0.M1 and <3.0.0-M1      |
# |                                      | Consumer Driven Contract (CDC) development.                  |                               |
# |                                      |                                                              |                               |
# | cloud-eureka                         | A REST based service for locating services for the purpose   | >=2.3.0.M1 and <3.0.0-M1      |
# |                                      | of load balancing and failover of middle-tier servers.       |                               |
# |                                      |                                                              |                               |
# | cloud-eureka-server                  | spring-cloud-netflix Eureka Server.                          | >=2.3.0.M1 and <3.0.0-M1      |
# |                                      |                                                              |                               |
...
# |                                      |                                                              |                               |
# | cloud-gcp                            | Contains auto-configuration support for every Spring Cloud   | >=2.4.0-M1 and <2.7.0-M1      |
# |                                      | GCP integration. Most of the auto-configuration code is only |                               |
# |                                      | enabled if other dependencies are added to the classpath.    |                               |
# |                                      |                                                              |                               |
# | cloud-gcp-pubsub                     | Adds the GCP Support entry and all the required dependencies | >=2.4.0-M1 and <2.7.0-M1      |
# |                                      | so that the Google Cloud Pub/Sub integration work out of the |                               |
# |                                      | box.                                                         |                               |
# |                                      |                                                              |                               |
# | cloud-gcp-storage                    | Adds the GCP Support entry and all the required dependencies | >=2.4.0-M1 and <2.7.0-M1      |
...
# |                                      |                                                              |                               |
# | cloud-starter-sleuth                 | Distributed tracing via logs with Spring Cloud Sleuth.       | >=2.3.0.M1 and <3.0.0-M1      |
# |                                      |                                                              |                               |
...
# |                                      |                                                              |                               |
# | cloud-starter-zipkin                 | Distributed tracing with an existing Zipkin installation and | >=2.3.0.M1 and <3.0.0-M1      |
...
# |                                      |                                                              |                               |
# | geode                                | Apache Geode is a data management platform that helps users  | >=2.3.0.M1 and <3.1.0-M1      |
...
# |                                      |                                                              |                               |
# | graphql                              | Build GraphQL applications with Spring for GraphQL and       | >=2.7.0.M1 and <3.0.0-M1      |
# |                                      | GraphQL Java.                                                |                               |
# |                                      |                                                              |                               |
...
# |                                      |                                                              |                               |
# | jersey                               | Framework for developing RESTful Web Services in Java that   | >=2.0.0.RELEASE and <3.0.0-M1 |
...
# |                                      |                                                              |                               |
# | native                               | Incubating support for compiling Spring applications to      | >=2.4.3 and <3.0.0-M1         |
...
# |                                      |                                                              |                               |
# | okta                                 | Okta specific configuration for Spring Security/Spring Boot  | >=2.1.2.RELEASE and <3.0.0-M1 |
...
# |                                      |                                                              |                               |
# | picocli                              | Build command line applications with picocli.                | >=2.4.0.RELEASE and <3.0.0-M1 |
# |                                      |                                                              |                               |
...
# |                                      | session information.                                         |                               |
# |                                      |                                                              |                               |
# | solace                               | Connect to a Solace PubSub+ Advanced Event Broker to         | >=2.2.0.RELEASE and <2.7.0-M1 |
# |                                      | publish, subscribe, request/reply and store/replay messages  |                               |
# |                                      |                                                              |                               |
# | spring-shell                         | Build command line applications with spring.                 | >=2.7.0 and <3.0.0-M1         |
# |                                      |                                                              |                               |
...
# |                                      |                                                              |                               |
# | wavefront                            | Publish Micrometer metrics to Tanzu Observability by         | >=2.3.0.M1 and <3.0.0-M1      |
